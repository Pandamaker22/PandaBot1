...
global.dfail = (type, m, conn) => {
  let msg = {
    rowner: 'Este comando só pode ser usado pelo *Dono* _',
    owner: 'Este comando só pode ser usado pelo _*Dono Do Bot*_!',
    mods: 'Este comando só pode ser usado pelo _*Moderador*_ !',
    premium: 'Este comando é apenas para membros _*Premium*_ !',
    group: 'Este comando só pode ser usado em grupos!',
    private: 'Este comando só pode ser usado no pv',
    admin: 'Este comando é apenas para *Admins* do Grupo!',
    botAdmin: 'Torne o bot *Admin* para usar este comando!',
    unreg: 'Registre-se para usar este recurso digitando:\n\n * # lista de nomes. Idade * \n\n Exemplo: * #daftar Nome.16 *'
  }[type]
